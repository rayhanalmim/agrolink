                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="price">
                                                        <h6>BDT<?php echo $product['fa'] ?></h6>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="qty">
                                                        <div class="box">
                                                            <input type="text" disabled="disabled" value="<?php echo $p_qy; ?>" />
                                                            <div class="btnbv">
                                                                <button
                    ...
                    ?>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <h6>BDT<?php echo $total_subtotal; ?></h6>
                                    </td>
                                </tr>
                            </table>
                            <div class="cktout">
                            ...
                            ?>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6>BDT<?php echo $ct['final_amt']; ?></h6>
                                        </td>
                                    </tr>
                                </table>
