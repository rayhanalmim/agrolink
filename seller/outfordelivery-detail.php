    ...
    <div class="gh">
        ...
        ?>
            ...
            ?>
                <div class="heading">
                    <h3> </h3>
                    <a href="javascript:void()0" onclick="delivered(<?php echo $oid ?>)"
                        class="bill-btn5 hover-btn">Delivered</a>
                    <a href="javascript:void()0" onclick="out_undelivered(<?php echo $oid; ?>)"
                        class="bill-btn5 hover-btn" style="display:none;">Undelivered</a>
                </div>
        <?php }
        } ?>
    </div>
