          ...
          <div class="order-placed-dt">
            ...
            <div class="delivery-address-bg">
              ...
              <ul class="address-placed-dt1">
                ...
                <li>
                  <p>
                    <i class="uil uil-phone-alt"></i>Phone Number :<span><?php echo $row['user_mobile'] ?></span>
                  </p>
                </li>
              </ul>
              ...
              ?>
                <div class="placed-bottom-dt">
                  The payment of <span>BDT<?php echo $row['final_val'] ?></span> you'll make when the deliver
