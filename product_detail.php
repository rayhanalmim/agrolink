            ...
            <div class="innerrow">
                <div class="left">
                    ...
                    <div class="subimages flex">
                        <div class="sub">
                            <img src="media/product/<?php echo $product['img1']; ?>" alt="sub-image" id="mi"
                                onclick="view(this)" />
                        </div>
                        <div class="sub">
                            <img src="media/product/<?php echo $product['img2']; ?>" alt="sub-image" id="mi"
                                onclick="view(this)" />
                        </div>
                        <div class="sub">
                            <img src="media/product/<?php echo $product['img3']; ?>" alt="sub-image" id="mi"
                                onclick="view(this)" />
                        </div>
                        <div class="sub">
                            <img src="media/product/<?php echo $product['img4']; ?>" alt="sub-image" id="mi"
                                onclick="view(this)" />
                        </div>
                    </div>
                </div>
