            ...
            <div class="searchrow">
                <div class="left">
                    ...
                    <div class="shop-by-depertment" style="margin-top:2rem;">
                        <h2>price range</h2>
                        <ul>
                            <input type="range" name="price" id="price-input" min="1" max="5000" value="2500"
                            ...
                            <div class="inrow" style="margin-top: 1.5rem;">
                                ...
                                <div class="in">
                                    <h4>BDT<span id="fnlp">2500</span></h4>
                                </div>
                                <div class="in">
                        ...
                        ?>
                                <div class="product" style="background:#fff">
                                    ...
                                    <div class="detail">
                                        ...
                                        <p class="price">BDT <span class="ftrp"><?php echo $product['fa'] ?></span></p>
                                    </div>
                                </div>
                        <?php
                            }
