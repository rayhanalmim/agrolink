            ...
            <div class="bspace">
                ...
                <table style="width:100%">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td
                                        style="padding: 1rem 0.8rem;border-bottom:1px solid #e2e2e2;text-align:center;font-size:1.4rem;">
                                        <img src="../media/product/<?php echo $p['img1']; ?>" alt="product"
                                    ...
                                    <td
                                        ...
                                        ?>
                                                <span
                                                    style="font-size: 1.1rem; padding:0.5rem; background:#ffa500a3;border-radius:10px">
                                ...
                                ?>
                                        <tr>
                                            <td style="border-bottom:1px solid #e2e2e2;">
                                                <input type="text" id="<?php echo $shipnameid ?>" placeholder="Courier name"
                                                    style="border:1px solid #e2e2e2;padding:0.5rem;width:10rem;margin-left:auto">
                                            </td>
                                            <td style="border-bottom:1px solid #e2e2e2;">
                                                <input type="text" id="<?php echo $shipid ?>" placeholder="Shipping Id"
                                                    style="border:1px solid #e2e2e2;padding:0.5rem;width:10rem">
                                            </td>
                                            <td style="border-bottom:1px solid #e2e2e2;">
                                ...
                                background-color: #556ee6;
                                color: #fff;"
                                                    onclick="ship_product('<?php echo $p['id']; ?>','<?php echo $shipid ?>','<?php echo $shipnameid ?>')">Undelivered</button>
                                            </td>
                                            <td style="border-bottom:1px solid #e2e2e2;"></td>
                                            <td style="border-bottom:1px solid #e2e2e2;">
                                            </td>
                ...
                <table style="margin-top:2rem;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem 0.8rem;font-size:1.5rem;"> BDT <?php echo $tp; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem 0.8rem;font-size:1.5rem;"> BDT <?php echo $rw['total_price']; ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 1rem 0.8rem;font-size:1.5rem;"> BDT<?php echo $total_com; ?></td>
                    </tr>
                    <?php
                    $h = 1;
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="padding: 1rem 0.8rem;font-size:1.5rem;"><?php
                                                                                ...
                                                                                ?>
                                    Pay to Seller:
                                    <input type="text" value="<?php echo $payable[$h]; ?>" id="<?php echo $cd; ?>"
                                        style="border:1px solid #e2e2e2;padding:0.5rem;width:10rem;margin-left:auto">
                                    <button style="height: 3.2rem;
                                width: 8rem;
                                border-radius: 5px;
                                background-color: #556ee6;
                                color: #fff;"
                                        onclick="pay('<?php echo $order_detail_id[$h]; ?>','<?php echo $cd; ?>')">Pay</button>
                                <?php
                                                                                }
                                ?>
                            </td>
                        ...
                        <?php if ($stlinfo == "Done") { ?>
                            <tr>
                                <td style="padding: 1rem 0.8rem;font-size:1.5rem;">Product <?php echo $h; ?>: </td>
                                <td style="padding: 1rem 0.8rem;font-size:1.5rem;"><?php
                                                                                    echo "Expected Payment: BDT" . $payable[$h];
                                                                                    ?></td>
                                <td style="padding: 1rem 0.8rem;font-size:1.5rem;"><?php
                                                                                    echo "Paid: BDT" . $payable2[$h];
                                                                                    ?></td>
                            </tr>
                    <?php }
                        $h++;
