                                                    ...
                                                    <ul class="order-dtsll">
                                                        ...
                                                        <li>
                                                            <div class="order-dt47">
                                                                <h4>Price</h4>
                                                                <div class="order-title">
                                                                    BDT<?php echo $rw['qty'] * $rw['fa']; ?>
                                                                </div>
                                                                <div class="order-title">
                                                                    BDT<?php echo $rw['delivered_qty'] * $rw['fa']; ?>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li>
                                    ...
                                    <div class="total-dt">
                                        ...
                                        ?>
                                            <div class="total-checkout-group bt0">
                                                ...
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Ordered Price</h4>
                                                    <span>BDT<?php echo $sellerInfo[$seller]["ordered"] ?></span>
                                                </div>
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Received Price</h4>
                                                    <span style="word-wrap:break-word;">
                                                        BDT<?php echo $sellerInfo[$seller]["received"] ?>
                                                    </span>
                                                </div>
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Commission</h4>
                                                    <span style="word-wrap:break-word;">
                                                        BDT<?php echo $sellerInfo[$seller]["commission"] ?>
                                                    </span>
                                                </div>
                                                <div class="cart-total-dil pt-3">
                                                    <h4>Final Payable</h4>
                                                    <span style="word-wrap:break-word;">
                                                        BDT<?php echo ($sellerInfo[$seller]["received"] - $sellerInfo[$seller]["commission"]) ?>
                                                    </span>
                                                </div>
                                                <?php
                                                    ...
                                                    <div class="cart-total-dil pt-3">
                                                        ...
                                                        <span style="word-wrap:break-word;">
                                                            <input type="text"
                                                                ...
                                                                style="border:1px solid #eaeaea;padding:0.8rem;"
                                                                value="<?php echo ($sellerInfo[$seller]["received"] - $sellerInfo[$seller]["commission"]) ?>">
                                                            <button style="
                                                    border-radius: 4px;
                                                    padding: 0.8rem;
